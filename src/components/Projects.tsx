...
const projectsData: Project[] = [
  ...
  },
  {
    ...
    category: "E-COMMERCE",
    description:
      "New design and flow for bag + checkout. Serves for Maze to apply UX/UI test for real coming customers to guide new headless transformation.",
  ...
  },
  {
    ...
    description:
      "New design with 2 layers of mega menu demo. Serves for Maze to apply UX/UI test for real coming customers.",
  ...
  },
  {
    ...
    description:
      "Design system serves as a fundamental framework to ensure consistency across content pieces to app experiences within David Jones' digital ecosystem.",
  ...
  },
  {
    ...
    category: "E-COMMERCE",
    description:
      "Australia and New Zealand's leading textile recycling company. Trusted and transparent, creating change for future generations.",
  ...
  },
  {
    ...
    category: "EDUCATION",
    description:
      "A new direction. A fresh perspective on education. Empowering you to become what you want to be.",
  ...
  },
  {
    ...
    category: "AGENCY",
    description:
      "Full-service creative agency based in Melbourne and Adelaide. Delivering bespoke marketing, branding, and digital solutions.",
